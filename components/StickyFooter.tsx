  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-[#141414]/95 backdrop-blur-sm border-t border-gray-800 p-3 md:p-4 shadow-[0_-4px_20px_rgba(0,0,0,0.5)] animate-slide-up">
      <div className="max-w-4xl mx-auto flex items-center justify-between gap-4">
        ...
        {/* Link envolvendo Botão Real para detecção do Pixel */}
        <a 
          href={link}
          target="_blank"
        ...
        >
          <button className="w-full md:w-auto bg-[#E50914] hover:bg-[#b2070f] text-white font-black uppercase py-3 px-8 rounded flex items-center justify-center gap-2 text-sm md:text-base shadow-lg transition-transform active:scale-95 animate-pulse border-none cursor-pointer">
